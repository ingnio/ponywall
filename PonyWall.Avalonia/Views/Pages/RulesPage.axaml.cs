...
{
    public partial class RulesPage : UserControl, INavigablePage
    {
        ...
        {
            // No timers to pause in this view.
        }
        ...
        private async void MnuCreate_Click(object? sender, RoutedEventArgs e)
        {
            ...
            var result = await RuleEditorWindow.ShowCreateDialog(parentWindow);
        ...
        private async void MnuModify_Click(object? sender, RoutedEventArgs e)
        {
            ...
            var result = await RuleEditorWindow.ShowModifyDialog(parentWindow, selected);
            if (result == null) return;
